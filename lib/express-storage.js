      ...
      if (result) {
        if (reqObj.method=='GET') {
          ...
          key_value_store.get('value:'+reqObj.userId+':'+reqObj.category+':'+reqObj.key, function(err, value) {
            console.log('store says:');console.log(err);console.log(value);
            callback(200, value);
          });
          ...
          key_value_store.set('value:'+reqObj.userId+':'+reqObj.category+':'+reqObj.key, reqObj.value, function(err, data) {
            console.log('store says:');console.log(err);console.log(data);
            callback(200, data);
          });
          ...
          if(tokens[newToken]) {
            ...
            key_value_store.set(tokenKey, JSON.stringify(tokens), function(err2) {
              if(err2) {
                ...
                console.log("Stored new token ", tokenKey, "=", tokens, "in store:", details.redirectUriPrefix+newToken);
